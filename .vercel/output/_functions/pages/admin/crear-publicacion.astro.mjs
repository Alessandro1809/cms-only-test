    ...
    /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
      ...
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsxs("label", { className: "flex items-center gap-3 cursor-pointer", children: [
          ...
          /* @__PURE__ */ jsx("span", { className: "text-sm font-semibold text-gray-400", children: "Destacar este post" })
        ] }),
        /* @__PURE__ */ jsx("p", { className: "text-xs text-gray-500 mt-1 ml-8", children: "Los posts destacados aparecerán en la sección principal del blog" })
      ] })
    ] })
  ] });
};
...
const EDITOR_CLASSES = "prose prose-sm sm:prose lg:prose-lg xl:prose-2xl mx-auto focus:outline-none min-h-[300px] p-4 [&_h1]:text-4xl [&_h1]:font-bold [&_h1]:mb-4 [&_h2]:text-3xl [&_h2]:font-bold [&_h2]:mb-3 [&_h3]:text-2xl [&_h3]:font-bold [&_h3]:mb-2 [&_ul]:list-disc [&_ul]:ml-6 [&_ul]:my-4 [&_ol]:list-decimal [&_ol]:ml-6 [&_ol]:my-4 [&_li]:my-1 [&_pre]:bg-gray-900 [&_pre]:p-4 [&_pre]:rounded-lg [&_pre]:my-4 [&_pre]:overflow-x-auto [&_pre]:text-gray-100 [&_pre]:border [&_pre]:border-gray-700 [&_code]:bg-gray-800 [&_code]:px-2 [&_code]:py-1 [&_code]:rounded [&_code]:text-sm [&_code]:font-mono [&_code]:text-gray-100 [&_iframe]:w-full [&_iframe]:aspect-video [&_iframe]:rounded-lg [&_iframe]:my-4";
    ...
    /* @__PURE__ */ jsxs(
      "select",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx("option", { value: "h1", style: { fontSize: "24px", fontWeight: "bold" }, children: "Título 1" }),
          /* @__PURE__ */ jsx("option", { value: "h2", style: { fontSize: "18px", fontWeight: "bold" }, children: "Título 2" }),
          /* @__PURE__ */ jsx("option", { value: "h3", style: { fontSize: "14px", fontWeight: "bold" }, children: "Título 3" })
        ]
      }
    ),
    /* @__PURE__ */ jsx(
      ...
      case "paragraph":
        ...
        if (paragraphText.trim()) {
          blocks.push({
            ...
            attrs: node.attrs || {}
            // Guardar todos los atributos incluyendo alineación
          });
        }
        break;
      case "heading":
...
const convertBlocksToHTML = (blocks) => {
  return blocks.map((block) => {
    switch (block.type) {
      ...
      case "bulletList":
        const bulletItems = block.items.map((item) => `<li>${item}</li>`).join("");
...
const formatPostForBackend = (postData) => {
  ...
  const formatted = {
    ...
    content: htmlContent,
    // Guardar como HTML en lugar de bloques
    categorie: postData.category,
    tags: postData.tags,
    status: postData.status || "DRAFT",
    featured: postData.featured || false
    // Enviar como boolean, por defecto false
  };
